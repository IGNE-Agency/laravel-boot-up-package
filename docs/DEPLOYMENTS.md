...
Your [`ProvidesProjectCommands` binding](CUSTOM_COMMANDS.md) is embedded at the
right positions (before/after migrations), with each description rendered as a
comment above its command.
