...
final readonly class StepSequence
{
    private const STAGES = [
        ...
        StartServer::class => ServeStage::Start,
        InstallComposerDependencies::class => ServeStage::Start,
        InstallFrontendDependencies::class => ServeStage::Start,
        ...
        CacheFrameworkFiles::class => ServeStage::Finalize,
        FinalizeApplication::class => ServeStage::Finalize,
        StartQueueWorker::class => ServeStage::Finalize,
        StartHorizon::class => ServeStage::Finalize,
        StartReverb::class => ServeStage::Finalize,
        StartScheduler::class => ServeStage::Finalize,
        BuildOrWatchAssets::class => ServeStage::Finalize,
        AnnounceApplication::class => ServeStage::Finalize,
    ];
    ...
    private const GROUPS = [
        ...
        CacheFrameworkFiles::class => 'finalize',
    ...
    private function groupLine(string $group, array $present): ?string
    {
        ...
        return match ($group) {
            ...
            'finalize' => 'Cache and finalize the application',
